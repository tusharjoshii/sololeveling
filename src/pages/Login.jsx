      ...
      <div className="w-full max-w-md z-10">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-sl-light-gray opacity-80">Sign in to continue your journey</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm">
              ...
              <Link to="/register" className="text-sl-soft-purple hover:text-sl-blue transition-colors">
                Sign up
              </Link>
            </p>
          </div>
